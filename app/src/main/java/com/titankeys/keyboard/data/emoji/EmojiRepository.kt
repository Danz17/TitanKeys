package com.titankeys.keyboard.data.emoji
...
object EmojiRepository {
    ...
    private fun mapCategoryRes(fileName: String): Int? {
        return when (fileName.substringBefore(".txt")) {
            "SMILEYS_AND_EMOTION" -> com.titankeys.keyboard.R.string.emoji_category_smileys_and_emotion
            "PEOPLE_AND_BODY" -> com.titankeys.keyboard.R.string.emoji_category_people_and_body
            "ANIMALS_AND_NATURE" -> com.titankeys.keyboard.R.string.emoji_category_animals_and_nature
            "FOOD_AND_DRINK" -> com.titankeys.keyboard.R.string.emoji_category_food_and_drink
            "TRAVEL_AND_PLACES" -> com.titankeys.keyboard.R.string.emoji_category_travel_and_places
            "ACTIVITIES" -> com.titankeys.keyboard.R.string.emoji_category_activities
            "OBJECTS" -> com.titankeys.keyboard.R.string.emoji_category_objects
            "SYMBOLS" -> com.titankeys.keyboard.R.string.emoji_category_symbols
            "FLAGS" -> com.titankeys.keyboard.R.string.emoji_category_flags
            else -> null
        }
    }
}
