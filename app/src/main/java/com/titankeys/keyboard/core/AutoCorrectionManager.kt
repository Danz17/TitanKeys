package com.titankeys.keyboard.core
...
class AutoCorrectionManager(
        ...
        val charsToDelete = if (lastChars.endsWith(correction.correctedWord)) {
            ...
            while (i >= 0 &&
                ...
                (textBeforeCursor[i].isWhitespace() ||
                        textBeforeCursor[i] in com.titankeys.keyboard.core.Punctuation.BOUNDARY)
            ) {
                deleteCount++
                i--
            }
    ...
    fun handleBoundaryKey(
        ...
        val boundaryChar: Char? = boundaryCharOverride ?: when {
            isSpaceKey -> ' '
            isEnterKey -> '\n'
            punctuationChar != null && punctuationChar in com.titankeys.keyboard.core.Punctuation.BOUNDARY -> punctuationChar
            else -> null
        }
        ...
        val punctuationChars = com.titankeys.keyboard.core.Punctuation.BOUNDARY
