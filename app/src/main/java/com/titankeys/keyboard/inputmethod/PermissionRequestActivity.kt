...
class PermissionRequestActivity : Activity() {
    companion object {
        ...
        const val ACTION_PERMISSION_GRANTED = "com.titankeys.keyboard.PERMISSION_GRANTED"
        const val ACTION_PERMISSION_DENIED = "com.titankeys.keyboard.PERMISSION_DENIED"
