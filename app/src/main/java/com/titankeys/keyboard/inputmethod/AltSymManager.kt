...
class AltSymManager(
    ...
    fun reloadSymMappings() {
        if (context != null) {
            val customMappings = com.titankeys.keyboard.SettingsManager.getSymMappings(context)
    ...
    fun reloadSymMappings2() {
        if (context != null) {
            val customMappings = com.titankeys.keyboard.SettingsManager.getSymMappingsPage2(context)
            if (customMappings.isNotEmpty()) {
                symKeyMap2.clear()
    ...
    fun handleAltCombination(
        ...
        return if (altChar != null) {
            val punctuationSet = com.titankeys.keyboard.core.Punctuation.AUTO_SPACE
