package com.titankeys.keyboard.backup
...
object PreferenceSchemas {
    private val titankeysPrefsSchema = PreferenceFileSchema(
        prefName = "titankeys_prefs",
        fixedKeys = mapOf(
    ...
    private val schemasByName = mapOf(
        titankeysPrefsSchema.prefName to titankeysPrefsSchema
    )
