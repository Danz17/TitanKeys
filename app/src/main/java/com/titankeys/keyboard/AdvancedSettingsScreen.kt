...
import com.titankeys.keyboard.backup.BackupManager
import com.titankeys.keyboard.backup.RestoreManager
...
fun AdvancedSettingsScreen(
    ...
    fun defaultBackupName(): String {
        ...
        return "titankeys-backup-${formatter.format(Date())}.zip"
    }
        ...
        if (uri != null) {
            scope.launch {
                ...
                val message = when (result) {
                    is com.titankeys.keyboard.backup.BackupResult.Success ->
                        context.getString(R.string.backup_completed)
                    is com.titankeys.keyboard.backup.BackupResult.Failure ->
    ...
    val restoreLauncher = rememberLauncherForActivityResult(
        ...
        if (uri != null) {
            scope.launch {
                ...
                val message = when (result) {
                    is com.titankeys.keyboard.backup.RestoreResult.Success ->
                        context.getString(R.string.restore_completed)
                    is com.titankeys.keyboard.backup.RestoreResult.Failure ->
