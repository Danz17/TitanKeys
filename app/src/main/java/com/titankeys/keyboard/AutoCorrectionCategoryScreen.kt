...
private fun UserDictionaryScreen(
    ...
    val userStore = remember { com.titankeys.keyboard.core.suggestions.UserDictionaryStore() }
    ...
    fun notifyDictionaryUpdated() {
        val intent = Intent("com.titankeys.keyboard.ACTION_USER_DICTIONARY_UPDATED").apply {
